...
/* C:\Project Novatama\posbill_cms/themes/posbill/pages/retail.htm */
class __TwigTemplate_cdae05ecb4132ddc5a3623ec157be2e47b8991b92cf4b83212b1d82f5fd23313 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<main>
    <section class=\"bg-no-repeat bg-center bg-cover h-[644px] flex items-center text-white\"
        ...
        // line 9
        echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(($context["BASEURL"] ?? null), 9, $this->source), "html", null, true);
        echo $this->extensions['System\Twig\Extension']->mediaFilter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["this"] ?? null), "page", [], "any", false, false, true, 9), "section1retail_background", [], "any", false, false, true, 9), 9, $this->source));
        echo "')\">
        <div class=\"container \">
            <h2 class=\"font-semibold text-[24px] mb-[29px]\">";
        // line 11
        echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["this"] ?? null), "page", [], "any", false, false, true, 11), "section1retail_subtitle", [], "any", false, false, true, 11), 11, $this->source), "html", null, true);
        echo "</h2>
            <h2 class=\"font-semibold md:text-[48px] sm:w-[565px] text-[40px] leading-tight mb-[20px]\">
                ";
        // line 13
        echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["this"] ?? null), "page", [], "any", false, false, true, 13), "section1retail_title", [], "any", false, false, true, 13), 13, $this->source), "html", null, true);
        echo "
            </h2>
            <div class=\"mb-[31px] w-[597px] font-semibold\">
                ";
        // line 16
        echo $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["this"] ?? null), "page", [], "any", false, false, true, 16), "section1retail_description", [], "any", false, false, true, 16), 16, $this->source);
        echo "
            </div>
            <a href=\"http://wa.me/6285157220258\" class=\"btn-gradient2 text-[#222222]\">";
        // line 18
        echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["this"] ?? null), "page", [], "any", false, false, true, 18), "section1retail_text_btn", [], "any", false, false, true, 18), 18, $this->source), "html", null, true);
        echo "</a>
        </div>
    </section>
    ...
    <section class=\"bg-fivety py-24\">
        <div class=\"container grid lg:grid-cols-2 grid-cols-1 gap-10\">
            <div class=\"flex items-center\">
                <img src=\"";
        // line 25
        echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(($context["BASEURL"] ?? null), 25, $this->source), "html", null, true);
        echo $this->extensions['System\Twig\Extension']->mediaFilter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["this"] ?? null), "page", [], "any", false, false, true, 25), "section2retail_image", [], "any", false, false, true, 25), 25, $this->source));
        echo "\" alt=\"\"
            ...
            <div class=\"flex items-center\">
                <div class=\"font-semibold text-[24px] text-[#222222] lg:w-[436px]\">
                    ";
        // line 30
        echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["this"] ?? null), "page", [], "any", false, false, true, 30), "section2retail_title", [], "any", false, false, true, 30), 30, $this->source), "html", null, true);
        echo "
                </div>
            </div>
        </div>
    ...
    <section class=\"mt-[70px]\">
        <div class=\"container\">
            <h2 class=\"font-semibold text-[#222222] text-[32px] text-center mb-[100px]\">
                ";
        // line 39
        echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["this"] ?? null), "page", [], "any", false, false, true, 39), "section3retail_title", [], "any", false, false, true, 39), 39, $this->source), "html", null, true);
        echo "
            </h2>
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, ($context["viewBag"] ?? null), "section3retail_2", [], "any", false, false, true, 42));
        foreach ($context['_seq'] as $context["_key"] => $context["card"]) {
            // line 43
            echo "            ";
            if ((twig_get_attribute($this->env, $this->source, $context["card"], "right", [], "any", false, false, true, 43) == true)) {
                // line 44
                echo "            <div class=\"grid lg:grid-cols-2 grid-cols-1 gap-20 mt-20\">
                <div class=\"flex flex-col justify-center gap-2\">
                    <h2 class=\"lg:text-right font-semibold text-[28px]\">";
                // line 46
                echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["card"], "title", [], "any", false, false, true, 46), 46, $this->source), "html", null, true);
                echo "</h2>
                    <div class=\"lg:text-right text-[20px] paragraf\">
                        ";
                // line 48
                echo $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["card"], "description", [], "any", false, false, true, 48), 48, $this->source);
                echo "
                    </div>
                </div>
                <div>
                    <img src=\"";
                // line 52
                echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(($context["BASEURL"] ?? null), 52, $this->source), "html", null, true);
                echo $this->extensions['System\Twig\Extension']->mediaFilter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["card"], "image", [], "any", false, false, true, 52), 52, $this->source));
            ...
            ";
                ...
                <div>
                    <img src=\"";
                // line 58
                echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(($context["BASEURL"] ?? null), 58, $this->source), "html", null, true);
                echo $this->extensions['System\Twig\Extension']->mediaFilter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["card"], "image", [], "any", false, false, true, 58), 58, $this->source));
                echo "\" alt=\"\" class=\"rounded-md\">
                </div>
                <div class=\"flex flex-col justify-center gap-2\">
                    <h2 class=\"font-semibold text-[28px]\">";
                // line 61
                echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["card"], "title", [], "any", false, false, true, 61), 61, $this->source), "html", null, true);
                echo "</h2>
                    <div class=\"text-[20px]\">
                        ";
                // line 63
                echo $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["card"], "description", [], "any", false, false, true, 63), 63, $this->source);
                echo "
                    </div>
                </div>
            </div>
...
";
    ...
    {
        return "C:\\Project Novatama\\posbill_cms/themes/posbill/pages/retail.htm";
    }
    ...
    {
        return array (  336 => 133,  332 => 132,  325 => 127,  321 => 125,  314 => 122,  312 => 121,  309 => 120,  298 => 117,  293 => 116,  289 => 115,  286 => 114,  279 => 111,  277 => 110,  274 => 109,  272 => 108,  268 => 106,  259 => 104,  248 => 98,  243 => 96,  236 => 95,  232 => 93,  223 => 90,  217 => 89,  214 => 88,  210 => 87,  207 => 86,  205 => 85,  201 => 84,  197 => 82,  192 => 81,  188 => 79,  186 => 78,  176 => 70,  169 => 68,  161 => 63,  156 => 61,  149 => 58,  145 => 56,  137 => 52,  130 => 48,  125 => 46,  121 => 44,  118 => 43,  114 => 42,  108 => 39,  96 => 30,  87 => 25,  77 => 18,  72 => 16,  66 => 13,  61 => 11,  55 => 9,  48 => 4,  44 => 3,  41 => 2,  39 => 1,);
    }
...
{% partial 'floatwa' %}
{% partial 'footer' %}", "C:\\Project Novatama\\posbill_cms/themes/posbill/pages/retail.htm", "");
    }
    
    public function checkSecurity()
    {
        static $tags = array("set" => 1, "partial" => 3, "for" => 42, "if" => 43);
        static $filters = array("escape" => 9, "media" => 9, "raw" => 16, "page" => 111);
