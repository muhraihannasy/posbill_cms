...
/* C:\xampp\htdocs\posbill_cms/themes/posbill/pages/dana.htm */
class __TwigTemplate_b61a2ec1766da97fa82d00dbcba77f0c32e33f7efa6f1fc7ad320d408e29974f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<main>
    <section class=\"bg-[#A71A65] lg:h-[644px] flex items-center text-white lg:pt-0 pt-[100px] pb-[50px]\">
        ...
        echo $this->extensions['System\Twig\Extension']->mediaFilter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["this"] ?? null), "page", [], "any", false, false, true, 48), "section1dana_image", [], "any", false, false, true, 48), 48, $this->source));
        echo "\" alt=\"\" class=\"lg:w-[483.36px]\">
            </div>
            <div class=\"lg:pt-20\">
                <h2 class=\"font-semibold text-[36px] mb-[24px]\">";
        // line 51
        echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["this"] ?? null), "page", [], "any", false, false, true, 51), "section1dana_title", [], "any", false, false, true, 51), 51, $this->source), "html", null, true);
        echo "</h2>
                <div class=\"mb-[31px] lg:w-[462px] text-[24px] font-light\">
                    ";
        // line 53
        echo $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["this"] ?? null), "page", [], "any", false, false, true, 53), "section1dana_description", [], "any", false, false, true, 53), 53, $this->source);
        echo "
                </div>
                <a href=\"\" class=\"btn-gradient2 text-[#222222]\">";
        // line 55
        echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["this"] ?? null), "page", [], "any", false, false, true, 55), "section1dana_text_btn", [], "any", false, false, true, 55), 55, $this->source), "html", null, true);
        echo "</a>
            </div>
        </div>
    </section>
    ...
    <section class=\"mt-[20px]\">
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, ($context["viewBag"] ?? null), "section2dana", [], "any", false, false, true, 63));
...
<footer class=\"bg-third mt-[100px] pt-20 pb-10\">
    ...
    {
        return "C:\\xampp\\htdocs\\posbill_cms/themes/posbill/pages/dana.htm";
    }
...
<main>
    <section class=\"bg-[#A71A65] lg:h-[644px] flex items-center text-white lg:pt-0 pt-[100px] pb-[50px]\">
        <div class=\"container grid lg:grid-cols-2 grid-cols-1 gap-10 \">
            <div class=\"flex lg:justify-end\">
                <img src=\"{{ BASEURL }}{{  this.page.section1dana_image|media }}\" alt=\"\" class=\"lg:w-[483.36px]\">
            </div>
            <div class=\"lg:pt-20\">
                <h2 class=\"font-semibold text-[36px] mb-[24px]\">{{ this.page.section1dana_title }}</h2>
                <div class=\"mb-[31px] lg:w-[462px] text-[24px] font-light\">
                    {{ this.page.section1dana_description|raw }}
                </div>
                <a href=\"\" class=\"btn-gradient2 text-[#222222]\">{{ this.page.section1dana_text_btn }}</a>
            </div>
        </div>
    </section>
    ...
    <section class=\"mt-[20px]\">
        <div class=\"container\">
            ...
            {% for card in viewBag.section2dana %}
...
</footer>", "C:\\xampp\\htdocs\\posbill_cms/themes/posbill/pages/dana.htm", "");
    }
